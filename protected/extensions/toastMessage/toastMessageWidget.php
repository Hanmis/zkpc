 ...
 */
  ...
  class toastMessageWidget extends CWidget{
      ...
      public function init(){
          ...
          Yii::app()->getClientScript()->registerScriptFile($this->assets.'/jquery.toastmessage.js'); 
          Yii::app()->getClientScript()->registerScriptFile($this->assets.'/css/jquery.toastmessage.css'); 
      ...
      public function run(){
            Yii::app()->getClientScript()->registerScriptFile($this->assets.'/jquery.toastmessage.js'); 
            Yii::app()->getClientScript()->registerCssFile($this->assets.'/css/jquery.toastmessage.css');
        ...
        Yii::app()->getClientScript()->registerScript("toast-message","
